    ...
    (() => {
        ...
        V = {
          websocket: class extends w {
            ...
            doOpen() {
              ...
              try {
                this.ws = U ? new F(t, e, s) : e ? new F(t, e) : new F(t);
              } catch (t) {
      ...
      const W = "function" == typeof ArrayBuffer,
        ...
        Q =
          "function" == typeof Blob ||
          ("undefined" != typeof Blob &&
            "[object BlobConstructor]" === J.call(Blob)),
        X =
          "function" == typeof File ||
          ("undefined" != typeof File &&
            "[object FileConstructor]" === J.call(File));
      function G(t) {
        return (
          (W && (t instanceof ArrayBuffer || $(t))) ||
          (Q && t instanceof Blob) ||
          (X && t instanceof File)
        );
      }
      ...
      var gt = s(906);
      const mt = document.querySelector("#game-list"),
        bt = document.querySelector("#available-game-item"),
        vt = yt();
      !(function (t) {
        t.on(gt.GAME_CREATED, ({ game_id: t, created_at: e }) => {
          mt.appendChild(
            (function (t, e) {
              const s = bt.content.cloneNode(!0);
              return (
                s
                  .querySelector("a")
                  .setAttribute("href", `/api/games/${t}/join`),
      ...
      const kt = document.querySelector("#messages");
      vt.on("chat-message", ({ message: t, sender: e }) => {
        console.log({ message: t, sender: e });
        const s = document.createElement("div"),
          n = document.createElement("span");
        n.innerText = e;
        const i = document.createElement("div");
        (i.innerText = t), s.appendChild(n), s.appendChild(i), kt.append(s);
      }),
        document
